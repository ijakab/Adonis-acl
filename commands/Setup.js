...
class SetupCommand extends Command {
    ...
    async handle () {
        try {
            await this.generateBlueprint('create_action_service')
            await this.generateBlueprint('create_actions')
            await this.generateBlueprint('create_role_action')
            await this.generateBlueprint('create_roles')
            await this.generateBlueprint('create_services')
            await this.generateBlueprint('create_user_role')
        } catch ({ message }) {
            this.error(message)
        }
    }
